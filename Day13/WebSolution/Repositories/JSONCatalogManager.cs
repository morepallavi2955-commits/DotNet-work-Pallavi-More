...
public static class JSONCatalogManager
{
    ...
    {
        return Path.Combine(Directory.GetCurrentDirectory(), "mockup", "customer.json");
    }
    ...
    {
        var json = File.ReadAllText(GetCustomerJsonFilePath());
      ...
      public static void SaveCustomers(IEnumerable<Customer> customers)
    {
        ...
        File.WriteAllText(GetCustomerJsonFilePath(), json);
    }
}